...
import { fetchRecommendationComments } from "../../../redux/recommendation/RecommendationThunks";
import RenderCommentComponent from "../../Common/CommentComponent";

const MySwal = withReactContent(Swal);

export const AddEditComment = () => {
  ...
  const commentsList = useSelector(
    (state) => state.recommendationReducer.commentList
  );
